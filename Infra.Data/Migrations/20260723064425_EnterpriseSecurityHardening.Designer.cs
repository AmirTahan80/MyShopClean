...
namespace Infra.Data.Migrations
{
    ...
    [Migration("20260723064425_EnterpriseSecurityHardening")]
    partial class EnterpriseSecurityHardening
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.AttributeTemplate", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AttributeTemplateId"));
            ...
            modelBuilder.Entity("Domain.Models.RequestPay", b =>
                {
                    ...
                    b.HasIndex("ApplicationUserId", "IsPay");
            ...
            modelBuilder.Entity("Domain.Models.SiteSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EmallsAccessToken")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<bool>("EmallsEnabled")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("TorobAccessToken")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<bool>("TorobEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domain.Models.UserFavoritesDetail", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UserFavoritesDetailId"));
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Domain.Models.RoleModel", null)
                        .WithMany()
