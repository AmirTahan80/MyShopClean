...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Adjective", b =>
                {
                    ...
                    b.Property<string>("AdjectiveName")
                        .IsRequired()
            ...
            modelBuilder.Entity("Domain.Models.SubValue", b =>
                {
                    b.Property<int>("SubValueId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("SubValueName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Models.Adjective", b =>
                {
                    b.HasOne("Domain.Models.Product", "Product")
                        .WithOne("Adjective")
                        .HasForeignKey("Domain.Models.Adjective", "ProductId")
            ...
            modelBuilder.Entity("Domain.Models.SubValue", b =>
                {
                    b.HasOne("Domain.Models.Value", "Value")
                        .WithMany("SubValues")
            ...
            modelBuilder.Entity("Domain.Models.Value", b =>
                {
                    b.HasOne("Domain.Models.Adjective", "Adjective")
                        .WithMany("Values")
